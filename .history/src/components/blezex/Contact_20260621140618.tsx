...
const contacts = [
  ...
  // { name: "Durga Prasad", phone: "9573308774" }, { name: "Hari Kumar", phone: "7660900361" },
];
            ...
            >
              ...
              <div className="space-y-2">
                ...
                {contacts.map((c) => (
                  <a
                    key={c.phone}
                    href={`tel:${c.phone}`}
                    className="block hover:text-primary transition text-base font-body"
                  >
                    👤 {c.name} • 📞 {c.phone}
                  </a>
                ))}
              ...
              <div>
                ...
                <a
                  ...
                  className="hover:text-primary text-base font-body"
                >
              ...
              <div>
                ...
                <span className="text-base font-body">Hyderabad • Visakhapatnam</span>
              </div>
            ...
            >
              ...
              <div className="glass rounded-2xl p-8">
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  <button
                    type="submit"
                    className="gradient-bg w-full py-4 rounded-xl font-semibold text-base text-primary-foreground flex items-center justify-center gap-2"
                  >
