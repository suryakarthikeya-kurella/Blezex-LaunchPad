...
const packages = [
  {
    ...
    features: ["Business Website (up to 5 pages)", "Mobile Responsive Design",  "Contact Form Integration","Basic SEO Setup","Google Maps Integration","WhatsApp Chat Button","Social Media Links", "1 Month Support"],
    recommended: false,
  },
  {
    name: "Startup",
    desc: "For growing startups that need a strong digital presence.",
    features: ["Custom Website or Web App","Up to 10 Pages & FullyResponsive","Modern UI/UX Design","SEO Optimization Setup","Blog / News Section Setup","Contact Form + WhatsApp Chat","Google Maps Integration","Speed Optimization","(Basic) Admin Panel / Content Management","Performance Optimization","3 Months Technical Support"],
    recommended: false,
  },
  {
