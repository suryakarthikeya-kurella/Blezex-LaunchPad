        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
          ...
          <div>
            ...
            <div className="flex items-center gap-4">
              ...
              <a href="https://x.com" target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-primary transition-colors">
                <Twitter size={24} />
              </a>
            ...
            <ul className="space-y-2">
              {["Home", "About", "Services", "Portfolio", "Packages", "Contact"].map((l) => (
                <li key={l}>
                  <a
                    href={`#${l.toLowerCase()}`}
                    className="text-sm text-gray-300 font-body hover:text-white transition-colors"
                  >
                    {l}
                  </a>
                </li>
