          ...
          <div>
            ...
            <div className="flex items-center gap-4">
              ...
              <a
                ...
                className="text-black dark:text-gray-300 hover:text-orange-500 transition-colors duration-200"
              >
                <Linkedin size={24} />
              </a>
            ...
            <ul className="space-y-2">
              {["Home", "About", "Services", "Portfolio", "Packages", "Contact"].map((l) => (
                <li key={l}>
                  <a
                    href={`#${l.toLowerCase()}`}
                    className="text-sm text-black dark:text-gray-300 font-body hover:text-orange-500 transition-colors duration-200"
                  >
                    {l}
                  </a>
                </li>
