          ...
          >
            ...
            <div className="space-y-5">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <p className="text-lg font-heading font-semibold text-primary mb-1">Phone</p>

                  <a
                    href="tel:8099655099"
                    className="flex items-center gap-2 text-foreground font-heading font-semibold hover:text-primary transition-colors"
                  >
                    <span>👤</span>
                    <span>Surya</span>
                    <span>📞</span>
                    <span>8099655099</span>
                  </a>
                    ...
                    className="flex items-center gap-2 text-foreground font-heading font-semibold hover:text-primary transition-colors" >
                    <span>👤</span>
                    <span>Raju Mokara</span>
                    <span>📞</span>
                    <span>9885803448</span>
                  </a>
                  ...
                  >
                    <span>👤</span>
                    <span>Durga Prasad</span>
                    <span>📞</span>
                    <span>9573308774</span>
                  </a>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <p className="text-lg font-heading font-semibold text-primary mb-1">Email</p>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <p className="text-lg font-heading font-semibold text-primary mb-1">Location</p>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <p className="text-lg font-heading font-semibold text-primary mb-1">Working Hours</p>
                  <p className="text-foreground font-heading font-semibold">
