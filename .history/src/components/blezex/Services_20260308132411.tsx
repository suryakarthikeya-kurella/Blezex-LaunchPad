...
const services = [
  ...
  },
  {
    ...
    subs: ["SEO Optimization (On-Page & Off-Page)", "Social Media Stratergy","Digital Growth Strategy","Paid Advertising","Content & Video Marketing","Email & Influencer Marketing"],
  },
  {
    icon: Palette,
