    ...
    >
      <div className="container mx-auto flex items-center justify-between px-4 py-4">
        ...
        <a href="#home" className="flex items-center gap-3">
          ...
          <span className="text-2xl md:text-3xl font-heading font-semibold gradient-text leading-none">
        ...
        <div className="flex lg:hidden items-center gap-2">
          ...
          <button onClick={() => setOpen(!open)} className="p-2 rounded-xl border border-border">
        ...
        {open && (
          ...
          >
            <nav className="flex flex-col p-4 gap-1">
              ...
              <a
                href="https://wa.me/918099655099?text=Hello%20BlezeX%20👋%0AI%20came%20from%20your%20website%20and%20would%20like%20a%20free%20consultation."
                target="_blank"
                rel="noopener noreferrer"
