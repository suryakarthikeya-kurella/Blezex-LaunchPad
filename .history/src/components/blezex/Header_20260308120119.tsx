      ...
      <div className="container mx-auto flex items-center justify-between px-4 py-4">
        ...
        <a href="#home" className="flex items-center gap-3">
          <img
            src="/logo.png"
            alt="BlezeX Logo"
            className="h-12 w-auto object-contain drop-shadow-[0_6px_10px_rgba(0,0,0,0.9)] hover:scale-105 transition"
          />

          <span className="text-2xl md:text-3xl font-heading font-extrabold">
