...
mport { Send, Phone, Mail, MapPin, Clock, MessageCircle } from "lucide-react";
            ...
            <div className="space-y-5">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a href="mailto:contact@blezex.com" className="text-foreground font-heading font-semibold hover:text-primary transition-colors">contact@blezex.com</a>
                </div>
              </div>
