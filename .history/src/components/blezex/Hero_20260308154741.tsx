...
const Hero = () => {
  ...
  return (
    ...
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden grid-bg">
      ...
      {/* Center Glow */}
      <div className="absolute w-[700px] h-[700px] bg-primary/20 blur-[160px] rounded-full top-[50%] left-[50%] -translate-x-1/2 -translate-y-1/2 pointer-events-none"></div>
...
export default Hero;import { motion } from "framer-motion";
import { ArrowRight, MessageCircle, Sparkles } from "lucide-react";
