...
const services = [
  ...
  },
  {
    ...
    subs: ["SEO Optimization (On-Page & Off-Page)", "Social Media Stratergy","Digital Growth Strategy","Content & Video Marketing","Email & Influencer Marketing","WhatsApp Marketing"],
  },
  {
    icon: Palette,
