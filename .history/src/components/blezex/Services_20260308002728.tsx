...
import {
  Globe, Smartphone, BrainCircuit, Server, Megaphone, Palette, Wrench,
} from "lucide-react";
...
const services = [
  ...
  },
  {
    icon: BrainCircuit,
    title: "AI & Automation",
    subs: ["AI Chatbots", "Business Process Automation", "AI Content Tools", "Data Analytics Dashboards"],
  },
  // {
  //   icon: Megaphone,
  //   title: "Digital Marketing & Growth",
  //   subs: ["SEO Optimization", "Social Media Marketing", "Content Marketing", "Digital Growth Strategy"],
  // },
  {
    icon: Palette,
    title: "Creative & Branding",
    subs: ["Graphic Design", "Logo Design", "Video Editing", "Social Media Reels", "Marketing Creatives"],
  },
  {
    icon: Wrench,
