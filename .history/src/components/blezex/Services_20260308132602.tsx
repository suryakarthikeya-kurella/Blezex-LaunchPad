...
const services = [
  ...
  },
  {
    ...
    subs: ["SEO Optimization (On-Page & Off-Page)","Paid Advertising (Google,Meta, Ads", "Social Media Stratergy","Digital Growth Strategy","Content & Video Marketing","Email & Influencer Marketing","WhatsApp Marketing"],
  },
  {
    icon: Palette,
