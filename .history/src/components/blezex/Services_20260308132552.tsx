...
const services = [
  ...
  },
  {
    icon: BrainCircuit,
    title: "AI & Automation",
    subs: ["AI Chatbots(Web/WhatsApp/Telegram)","AI Agents", "Business Process Automation","Customer Support Automation", "AI Content Generation Tools", "AI Assistants"],
  },
  {
    icon: Megaphone,
    title: "Digital Marketing & Growth",
    subs: ["SEO Optimization (On-Page & Off-Page)","Paid Advertising (Google,Meta,facebook Ads", "Social Media Stratergy","Digital Growth Strategy","Content & Video Marketing","Email & Influencer Marketing","WhatsApp Marketing"],
  },
  {
    icon: Palette,
