...
const Contact = () => {
  ...
  const inputClass = "w-full rounded-xl border border-border bg-card px-4 py-3 text-sm font-body text-foreground placeholder:text-muted-foreground outline-none focus:ring-2 focus:ring-primary/50 transition-colors";
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid lg:grid-cols-2 gap-12 max-w-6xl mx-auto">
          ...
          <motion.div
            ...
            className="space-y-6"
          >
            <h3 className="text-2xl font-heading font-bold text-foreground">Contact Information</h3>

            <div className="space-y-5">
              <div className="flex items-start gap-4">
                <div className="w-10 h-10 rounded-xl gradient-bg flex items-center justify-center flex-shrink-0">
                  <Phone1 size={18} className="text-primary-foreground" />
                  <Phone2 size={18} className="text-primary-foreground" />
                </div>
                <div>
                  <p className="text-sm font-body text-primary font-medium">Phone1</p>
                  <a href="tel:+918099655099" className="text-foreground font-heading font-semibold hover:text-primary transition-colors">+91 8099655099</a>
                  <p className="text-sm font-body text-primary font-medium">Phone2</p>
                  <a href="tel:+919573308774" className="text-foreground font-heading font-semibold hover:text-primary transition-colors">+91 9573308774</a>
                </div>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a href="mailto:blezex.vibe@gmail.com" className="text-foreground font-heading font-semibold hover:text-primary transition-colors">contact@blezex.com</a>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-foreground font-heading font-semibold">Visakhapatnam | Hyderabad</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-foreground font-heading font-semibold">Mon-Sat: 9:00 AM - 6:00 PM</p>
                </div>
              </div>
            </div>
          ...
          >
            <div className="glass rounded-2xl p-8">
              <h3 className="text-2xl font-heading font-bold text-foreground mb-6">Send Us Your Requirements</h3>
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div className="grid sm:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      required placeholder="+91 XXXXX XXXXX" value={form.phone}
                ...
                <div>
                  <label className="block text-sm font-heading font-semibold text-foreground mb-1.5">
                    Detailed Requirements <span className="text-destructive">*</span>
                  </label>
                  <textarea
                    required placeholder="Tell us about your project requirements, goals, and timeline..."
                    rows={5} value={form.details}
                ...
                <button
                  type="submit"
                  className="gradient-bg w-full py-4 rounded-xl font-heading font-semibold text-primary-foreground flex items-center justify-center gap-2 glow-hover hover:scale-[1.02] transition-all text-base"
                >
