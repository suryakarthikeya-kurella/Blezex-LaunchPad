...
const packages = [
  {
    ...
    features: ["Business Website (up to 5 pages)", "Mobile Responsive Design",  "Contact Form Integration","Basic SEO Setup","Google Maps Integration","WhatsApp Chat Button",, "1 Month Support"],
    recommended: false,
  },
  {
    name: "Startup",
