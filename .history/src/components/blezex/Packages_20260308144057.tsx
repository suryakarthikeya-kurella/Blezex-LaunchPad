...
const packages = [
  ...
  },
  {
    ...
    features: ["Custom Website or Web App","Up to 10 Pages & FullyResponsive","Modern UI/UX Design","SEO Optimization Setup","Blog / News Section Setup","Contact Form + WhatsApp Chat",""],
    recommended: false,
  },
  {
